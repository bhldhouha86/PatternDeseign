...
@section('title',"Famely Shoes-home")
@section('slider')
<!-- ======= Hero Section ======= -->
<div id="hero">
  <div id="heroCarousel" data-bs-interval="5000" class="carousel slide carousel-fade" data-bs-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      ...
      <!-- Slide 1 -->
      <div class="carousel-item active" style="background-image: url({{asset('images/boutique1.jpg')}});">
        <div class="carousel-container">
          <div class="carousel-content animate__animated animate__fadeInUp">
            <h2>Welcome to <span>Family Shoes</span></h2>
            <p>« Family Shoes » est une boutique spécialisée dans la vente de chaussures et accessoires pour hommes, femmes et Enfants.</p>
            <div class="text-center"><a href="" class="btn-get-started">Découvrir </a></div>
          </div>
        </div>
      </div>

      <!-- Slide 2 -->
      <div class="carousel-item" style="background-image: url({{asset('images/boutique2.jpg')}});">

      </div>

      <!-- Slide 3 -->
      <div class="carousel-item" style="background-image: url({{asset('images/boutique3.jpg')}});">

      </div>
      <!-- Slide 4 -->
      <div class="carousel-item" style="background-image: url({{asset('images/boutique4.jpg')}});">

      </div>
      <!-- Slide 5 -->
      <div class="carousel-item" style="background-image: url({{asset('images/boutique5.jpg')}});">
